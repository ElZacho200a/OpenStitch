...
satin_guide_junctions(const document::SatinParams& satin,
...
satin_guide_junction(const document::SatinParams& satin, std::size_t guide_index,
                     Micrometers flatten_tolerance = Micrometers{100});
...
satin_junction_guides(const document::Project& project, ObjectId source_vector,
                      std::uint32_t junction_id, Micrometers flatten_tolerance = Micrometers{100});
...
[[nodiscard]] std::optional<std::uint32_t>
next_satin_guide_link_id(const document::Project& project, ObjectId source_vector);
...
[[nodiscard]] std::optional<document::SatinRung>
move_satin_guide_endpoint(const document::SatinParams& satin, std::size_t guide_index,
...
[[nodiscard]] std::optional<SatinGuideInsertion>
make_satin_guide_in_largest_gap(const document::SatinParams& satin,
                                Micrometers flatten_tolerance = Micrometers{100});
...
make_satin_guide_next_to_junction(const document::SatinParams& satin,
                                  std::size_t junction_guide_index,
                                  Micrometers flatten_tolerance = Micrometers{100});
