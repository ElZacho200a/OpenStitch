...
- Total au dernier passage vérifié : **339 tests CTest**, 100 % réussis.
...
| Élément | Valeur |
|---|---|
| Commit (état du code testé) | `b8ccc57` — transaction coordonnée des guides de jonction |
| Compilateur | MSVC toolset 14.50 (Visual Studio 2026) |
| CMake | 4.4.0-rc3 |
| Configurations | Debug **et** Release |
| Résultat CTest | 339 / 339 réussis |
| Tests désactivés | 0 |
...
suite côté QTest) ; le nombre d'**assertions** est supérieur. Le chiffre 339
...
- **Édition des guides satin** : QTest headless sur le clic de sélection, l'ajout
  ...
  l'absence de mutation partielle avec cible obsolète ou dupliquée.
